...
- Add GitHub Actions CI/CD pipelines: `lint.yml` (strict formatting), `test.yml` (Zig unit tests), `deno-test.yml` (Deno Autobahn compliance testsuite), and `publish.yml` (Nix-driven multi-platform releases).
